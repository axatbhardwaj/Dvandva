...
- Block in `scripts/dvandva-wait.sh --role vadi` once the baton assigns review to prativadi.
...
- Block in `scripts/dvandva-wait.sh --role prativadi` once the baton assigns implementation back to vadi.
