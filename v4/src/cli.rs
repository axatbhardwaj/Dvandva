...
fn transition_error_code(error: &TransitionError) -> &'static str {
    match error {
        ...
        TransitionError::WrongExplainerAuthor => "wrong_explainer_author",
        ...
        TransitionError::ExplainerNotApproved => "explainer_not_approved",
        TransitionError::ExplainerNotPublished => "explainer_not_published",
