...
echo "Done. Verify the installed engine(s) can see dvandva:vadi, dvandva:prativadi, dvandva:research, dvandva:testing, dvandva:understanding, and dvandva:worktree-setup in /skills."
